...
Experiência profissional superior a 3 anos como Vue.js Developer
Experiência sólida em desenvolvimento Front-end
Conhecimentos sólidos de: JavaScript, TypeScript, HTML5 e CSS3
Experiência com ferramentas de controlo de versões (Git)
Experiência de trabalho em metodologias Agile (Scrum)
Experiência com JIRA ou ferramentas equivalentes
Experiência na implementação e execução de testes unitários
