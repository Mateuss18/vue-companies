...
Diseñar, desarrollar y mantener soluciones fullstack para portales y configuradores, asegurando calidad, escalabilidad y mantenibilidad.
Preparar y evolucionar la base técnica del proyecto: entornos, inicialización, integración continua y despliegue continuo con GitHub.
Construir frontend en Vue.js y backend en Java/Spring Boot 3, aplicando arquitectura hexagonal y diseño orientado a eventos.
Integrar y validar datos de proveedores mediante APIs externas, garantizando coherencia, seguridad y buen rendimiento.
Participar en revisiones de código, definición técnica y mejora continua siguiendo prácticas BDD, TDD y DDD.

🎯Requisitos

Experiencia como desarrollador/a con foco en Java y Vue.js.
Dominio de Java 17, Spring Boot 3, Vue 3.
Conocimientos en arquitectura hexagonal, Event Driven, Event Sourcing, CQRS y diseño orientado al dominio.
Experiencia con PostgreSQL, Redis, APIs REST/Google APIs, así como herramientas de seguridad como OAuth 2.0, OpenID Connect y Vault.
Valorable experiencia en GKE, GitHub, Datadog y buenas prácticas de testing, observabilidad y despliegue en cloud.
Inglés B2
...
Link: https://www.linkedin.com/jobs/view/4385048499/
