...
- Desenvolver soluções e realizar manutenção das soluções e sistemas existentes;
- Entregar código limpo e fácil de se manter, priorizando segurança e estabilidade;
...
- Atuar com pró atividade constante e apresentar solução para situações técnicas e de negócio;
- Prestar suporte ao cliente interno e externo, sempre que necessário.

## Requisitos e qualificações

- Domínio em lógica de programação;
- Experiência na linguagem de programação **Java**;
- Experiência no Framework **Spring e Spring Boot**;
- Experiência no Framework **Vue.js**;
- Experiência em **Teste Unitários**;
- Conhecimento em **JavaScript e TypeScript**;
- Conhecimento em **REST Services**;
- Conhecimento em sistema de versionamento;
...
- Conhecimento do sistema Unimed;
- Conhecimento de operadora de plano de saúde;
- Conhecimento DevOps.
